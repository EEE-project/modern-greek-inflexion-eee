...
from modern_greek_inflexion_eee.resources.typing import recognized_conjugation_type
from modern_greek_inflexion_eee.resources.variables import *
from modern_greek_inflexion_eee.resources.verb import ancient_oomai
