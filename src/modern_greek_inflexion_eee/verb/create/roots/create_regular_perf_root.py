from modern_greek_inflexion_eee.resources.typing import voiceType, presentConjugationType
from modern_greek_inflexion_eee.resources.variables import ACTIVE, PASSIVE
from modern_greek_inflexion_eee.verb.create.roots.create_regular_perf_active_root import create_regular_perf_active_root
from modern_greek_inflexion_eee.verb.create.roots.create_regular_perf_passive_root import create_regular_perf_passive_root
