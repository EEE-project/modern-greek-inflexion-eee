...
from modern_greek_accentuation_eee.resources import vowels, prefixes_before_augment

from modern_greek_inflexion_eee.resources import greek_corpus
from modern_greek_inflexion_eee.resources.verb import irregular_passive_perfect_participles
