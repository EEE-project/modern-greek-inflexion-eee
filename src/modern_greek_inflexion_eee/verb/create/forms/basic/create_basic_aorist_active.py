...
from modern_greek_inflexion_eee.resources.prefixes import prefixes_before_augment
from modern_greek_inflexion_eee.verb.helpers import aorist_exists
from modern_greek_inflexion_eee.resources.variables import PENULTIMATE
from modern_greek_inflexion_eee.resources.verb import irregular_active_aorists


def create_basic_aorist_active(pres_form: str,
                               active_root: str,
