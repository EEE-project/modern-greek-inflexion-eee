...
from modern_greek_accentuation_eee.accentuation import put_accent_on_the_antepenultimate, put_accent_on_the_penultimate

from modern_greek_inflexion_eee.resources.typing import presentConjugationType
from modern_greek_inflexion_eee.verb.helpers import check_personal_forms
from modern_greek_inflexion_eee.resources import CONJUGATION_IND, ROOT, CON2A_PASS, CON2B_PASS, CON2AK_PASS, CON2A_ACT, \
    CON2AK_ACT, CON2B_ACT, CON2D_ACT, CON2C_ACT, CON1_ACT, greek_corpus
from modern_greek_inflexion_eee.verb.recognize import recognize_passive_present_continuous_conjugation, \
