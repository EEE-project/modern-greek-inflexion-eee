from modern_greek_inflexion_eee.resources import greek_pattern
from modern_greek_inflexion_eee.resources.prefixes import prefixes_before_augment, prefixes_detachable, \
    prefixes_detachable_weak
from modern_greek_inflexion_eee.resources.typing import basic_forms_type
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_aorist_forms import create_basic_aorist_forms
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_conjunctive_forms import create_basic_conjunctive_forms
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_paratatikos_forms import create_basic_paratatikos_forms
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_present_forms import create_basic_present_forms
from modern_greek_inflexion_eee.verb.create.forms.basic.participles.create_aorist_participles import \
    create_active_aorist_participle, create_passive_aorist_participle
from modern_greek_inflexion_eee.verb.create.forms.basic.participles.create_passive_perfect_participle import \
    create_passive_perfect_participle
from modern_greek_inflexion_eee.verb.create.forms.basic.participles.create_present_active_participle import \
    create_present_active_participle
from modern_greek_inflexion_eee.verb.create.forms.basic.participles.create_present_active_participle_arch import \
...
from modern_greek_inflexion_eee.resources.variables import ACTIVE, PASSIVE, MODAL, AORIST, PRESENT, PARATATIKOS, \
...
from modern_greek_inflexion_eee.exceptions import NotLegalVerbException, NotInGreekException
