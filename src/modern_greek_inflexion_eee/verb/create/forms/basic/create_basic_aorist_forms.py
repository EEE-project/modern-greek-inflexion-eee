from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_aorist_active import create_basic_aorist_active
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_aorist_passive import create_basic_aorist_passive
