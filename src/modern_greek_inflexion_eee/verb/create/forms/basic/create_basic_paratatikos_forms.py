...
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_paratatikos_active import \
    create_basic_paratatikos_active
from modern_greek_inflexion_eee.verb.create.forms.basic.create_basic_paratatikos_passive import \
