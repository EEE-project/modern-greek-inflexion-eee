...
from modern_greek_inflexion_eee.resources.typing import presentConjugationType, voiceType, aspectType, personal_forms_type
...
from modern_greek_inflexion_eee.verb.create.roots.create_roots_from_past import create_stem_from_augmented_past
