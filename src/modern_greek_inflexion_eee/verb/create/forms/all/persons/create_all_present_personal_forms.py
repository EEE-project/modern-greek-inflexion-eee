from modern_greek_inflexion_eee.resources.typing import voiceType, personal_forms_type
from modern_greek_inflexion_eee.verb.helpers import compound_alternative_forms
from modern_greek_inflexion_eee.resources import ACTIVE, PASSIVE, IND, ROOT, CONJUGATION_IND, CONJUGATION_IMP, \
    CON1_ACT_MODAL, SG, TER, MODAL
from modern_greek_inflexion_eee.verb.create.forms.all.persons.create_all_pers_forms import create_all_pers_forms
from modern_greek_inflexion_eee.verb.recognize import recognize_active_non_past_conjugation, \
