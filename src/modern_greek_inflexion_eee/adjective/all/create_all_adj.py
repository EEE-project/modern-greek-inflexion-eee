...
from modern_greek_inflexion_eee.adjective._helpers import put_accent_on_all_forms, put_accent_on_unaccented_forms
from modern_greek_inflexion_eee.resources import greek_corpus
from modern_greek_inflexion_eee.resources.adj import adj_basic_template
from modern_greek_inflexion_eee.resources.typing import genders_declensions_type, adj_declension_degree_type
from modern_greek_inflexion_eee.resources.variables import SG, PL, FEM, MASC, NEUT, NOM, GEN, ACC, VOC, ANTEPENULTIMATE, \
