...
from modern_greek_inflexion_eee.resources.variables import (ADJ, ADVERB, ADVERB_COMPARATIVE, COMPARATIVE, INCORRECT_ACCENT,
                                                        ULTIMATE,
                                                        ANTEPENULTIMATE, PENULTIMATE, ADJ_FEM_OS_ONLY, ADJ_FEM_OS_ALSO)
from modern_greek_inflexion_eee.resources.adj import irregular_comparatives, irregular_comparative_adverbs, \
    adj_grammar_lists
