...
def create_all_pron_forms(bas_forms: str, strong: bool = True) -> genders_declensions_type:
    ...
    if masc != neut:
        if masc == 'ούτος':
            ...
            if masc == 'αυτός':
                if strong:
                    from modern_greek_inflexion_eee.resources.pronouns import AUTOS_STRONG
                    forms = AUTOS_STRONG
                else:
                    from modern_greek_inflexion_eee.resources.pronouns import AUTOS_WEAK
                    forms = AUTOS_WEAK
        ...
        # ενας, μια, ενα
            ...
            from modern_greek_inflexion_eee.resources.pronouns import TIS
            return TIS
